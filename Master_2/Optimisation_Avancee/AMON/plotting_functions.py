...
def plot_terrain(x, y, obj_function, units, obj_function_value, n_wt, ub, boundary_shapely, exclusion_zones_shapely, wind_rose_path="", max_index="", max_ws="", cg="", ax="", plot_flow_map=False, full_wind_rose=False, save=False, save_name="",show=True):
