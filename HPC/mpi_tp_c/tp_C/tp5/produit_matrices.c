...
int main(int argc, char *argv[]) {
  ...
  /* TODO: Le processus 0 diffuse N à tous les autres processus */
  ...
  /* TODO: Le processus 0 distribue dans AL les tranches horizontales de A */
  

  /* TODO: Le processus 0 distribue dans BL les tranches verticales de B */
  ...
  for (iter=0; iter<Nprocs; iter++) {
    if (rang != iter) {
      // TODO: Chaque processus ENVOIE sa tranche AL au processus iter
  ...
  //for (iter=1; iter<Nprocs; iter++) {
    // TODO: Chaque processus ENVOIE sa tranche AL au processus precedent
  ...
  /* TODO: Le processus 0 collecte les tranches CL de tous les processus
